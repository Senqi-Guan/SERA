...
def main():
    ...
    # setup model
    model = create_cls_model(config["net_config"]["name"], False, dropout=config["net_config"]["dropout"], weight_url=args.weight_url)
    # model = create_cls_model(config["net_config"]["name"], True, dropout=config["net_config"]["dropout"], weight_url=args.weight_url)
